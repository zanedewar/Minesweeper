...
def makeGuess(backBoard, frontBoard, guess):
    ...
    if(val == -1):
        ...
        if(cells[0]):
            y = y0-1
            frontBoard = makeGuess(backBoard, frontBoard, (x,y)) if frontBoard[x][y] != "" else frontBoard
            if(cells[2]):
                frontBoard = makeGuess(backBoard, frontBoard, (x-1,y)) if frontBoard[x-1][y] != "" else frontBoard
            if(cells[3]):
                frontBoard = makeGuess(backBoard, frontBoard, (x+1,y)) if frontBoard[x+1][y] != "" else frontBoard
        if(cells[1]):
            y = guess[1]+1
            ...
            if(cells[3]):
                frontBoard = makeGuess(backBoard, frontBoard, (x+1,y)) if frontBoard[x+1][y] != "" else frontBoard
        if(cells[2]):
            frontBoard = makeGuess(backBoard, frontBoard, (x-1, y0)) if frontBoard[x-1][y0] != "" else frontBoard
        if(cells[3]):
            frontBoard = makeGuess(backBoard, frontBoard, (x+1, y0)) if frontBoard[x+1][y0] != "" else frontBoard
